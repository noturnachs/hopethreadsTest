...
const Work = () => {
  ...
  return (
    <div
      className={`grid grid-cols-2 md:mt-32 gap-6 justify-items-center md:flex md:flex-row md:justify-center md:space-x-8 transition-transform duration-700 ease-in-out ${
